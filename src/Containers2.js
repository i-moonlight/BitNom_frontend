...
import {
  ...
  //   withClient,
} from '@titelmedia/react-apollo-multiple-clients';
...
export const AppContainers = () => {
  ...
  return (
    <div className={classes.root}>
      <BrowserRouter>
        <ApolloMultipleClientsProvider clients={apolloClients}>
          <AppRoutes />
        </ApolloMultipleClientsProvider>
      </BrowserRouter>
    </div>
...
const AppRoutes = () => (
  <Switch>
    ...
    <Route exact component={RequireVerification} path='/auth/require_verify' />
    <Route exact component={VerifyEmail} path='/auth/verify_email' />
    <Route exact component={ResetPassword} path='/auth/request_reset_link' />
    <Route exact component={CreatePassword} path='/auth/password_reset/:key' />
