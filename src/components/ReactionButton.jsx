...
export default function ReactionButton({
  ...
  return (
    <MuiButton
      ...
      onClick={() => (reaction ? handleRemoveReaction() : setLikeHovered(true))}
      {...props}
    >
      {!reaction && (
        <AvatarGroup className={classes.root} max={4}>
          <Avatar className={classes.primary} color="primary" alt="Like">
            <ThumbUpRounded className={classes.small} />
          </Avatar>
          <Avatar className={classes.red} alt="Love">
            <FavoriteRounded className={classes.small} />
          </Avatar>
          <Avatar className={classes.primary} color="primary" alt="Dislike">
