          ...
          <Grid item md={6} className='my-5'>
            <div className='m-3'>
              ...
              >
                ...
                venturing into cryptocurrencies and budding
                cryptocurrency-related projects and businesses: Blockchain
                technology, BNConnect, BNMarket, and BitNorm›s knowledge center.
              </Typography>
              <Typography className={classes.sectionText} color='textPrimary'>
                It is our goal to deliver on this promise. We aim to construct
                seamless integrations between these elements that will allow
                you, our user, to unceremoniously wear the hats of a learner,
                seller, investor, and master as you use our platform.
              </Typography>
            </div>
          </Grid>
          ...
          <Grid item md={6} sm={10} className='my-5'>
            <div className='m-3 pt-3'>
              ...
              <Typography
                ...
                color='textPrimary'
              >
                BN Social is a BitNorm›s social media tool that allows users
