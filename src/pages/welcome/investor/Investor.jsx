              ...
              <div className='p-4 px-5'>
                <DarkTheme>
                  ...
                  <Typography color='textPrimary' gutterBottom className='my-4'>
                    Underlying all activities on the BitNorm application are 3
                    key ideologies: learn, share, and profit. Our goal,
                    therefore, is to unite learners, professionals, and
                    businesses all under one roof with each one of the benefits
                    from the other.
                  </Typography>
                  <Button
                    size='large'
