      ...
      <BitnormPaper title='BitNorm Cookie Policy'>
        <>
          ...
          <p>
            ...
            the Technology Platform and stored on your computer's hard drive.
          </p>
          <p>
            Cookies enable the Technology Platform to remember your actions and
            preferences (such as login, language, font size and other display
            preferences) over a period of time, so you don’t have to keep
            re-entering them whenever you come back to the Technology Platform
          ...
          <p>
            This Technology Platform uses Google Analytics, a web analytics
            ...
            Technology Platform analyze how users use the site. The information
            generated by the cookie about your use of different sites (including
            ...
            the purpose of evaluating your use of sites, compiling reports on
            sites activity for sites operators and providing other services
            relating to sites activity and internet usage. Google may also
            ...
            functionality of the Technology Platform. By using the Technology
            Platform, you consent to the processing of data about you by Google
          ...
          <p>
            You can control and/or delete cookies if you wish. You can delete
            all cookies that are already on your computer and you can set most
            browsers to prevent them from being stored therein. If you do this,
            however, you may have to manually adjust some preferences every time
            you visit the Technology Platform and some services and
