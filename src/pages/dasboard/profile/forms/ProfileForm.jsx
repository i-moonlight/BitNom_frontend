...
export default function ProfileForm({ onClose, updateData }) {
  ...
  return (
    <div className="mt-2">
      <Form
        initialValues={
          updateData || { displayName: "", website: "", portfolio: "" }
        }
        validationSchema={profileValidation}
        onSubmit={({ displayName, website, portfolio }, { resetForm }) => {
          setLocalError(null);
        ...
        <Card className={classes.formCard}>
          <CardContent>
            <TextField
              ...
              name="displayName"
              labelTop="Your Name"
              placeholder={updateData?.bio || "Full name to be displayed"}
            />
            <TextField
              required
              fullWidth
              ...
              placeholder={updateData?.website || "Your Website URL"}
            />
            <TextField
              required
              fullWidth
              ...
              placeholder={updateData?.portfolio || "Your Portfolio URL"}
            />
