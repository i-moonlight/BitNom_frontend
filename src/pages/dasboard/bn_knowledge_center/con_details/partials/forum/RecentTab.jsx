    ...
    return(<>
        <Fragment>
            <div className={'row mt-3'}>
                <Card className={'col-sm-12 col-md-3 col-lg-3'} style={{ height: '30vw'}}>
                    <h5 className={'mt-2'}>
                        <strong>Category</strong>
                    </h5>
                    <div className={'m-3 h-70'}>
                        <div>
                            <Button color={'inherit'} className={` ${btnColor.categoryActive}`}>
                                <Home  className={'me-3'} /> General Discussion
                            </Button>
                        </div>
                        <div>
                            <Button color={'inherit'} className={` ${btnColor.categoryNormal}`}>
                                <EmojiPeople className={'me-3'} /> Ideas
                            </Button>
                        </div>
                        <div>
                            <Button color={'inherit'}  className={` ${btnColor.categoryNormal}`}>
                                <Announcement  className={'me-3'} /> Announcement
                            </Button>
                        </div>
                        <div>
                            <Button color={'inherit'}  className={` ${btnColor.categoryNormal}`}>
                                <Message color={'inherit'}  className={'me-3'} /> Q&amp;A
                            </Button>
                        </div>
                    </div>
                    <section>
                                ...
                                {rows.map((row, id) => (
                                    <TableRow key={id} sx={{'&:last-child td, &:last-child th': { border: 0 },}}>
                                        ...
                                        <TableCell>
                                            ...
                                            <p>By <a href={'#'}>Don Phelix</a> On {row.date}</p>
                                        </TableCell>
                                        <TableCell>
                                            <AvatarGroup max={4} color={'red'}>
                                                <Avatar alt="Remy Sharp" src="https://picsum.photos/200" color={'inherit'}
                                                        style={{border: '0.1px solid lightgray'}}/>

                                                <Avatar alt="Travis Howard" src="https://picsum.photos/seed/picsum/200"
                                                        style={{border: '0.1px solid lightgray'}}/>
                                                <Avatar alt="Cindy Baker" src="https://picsum.photos/200/300?grayscale"
                                                        style={{border: '0.1px solid lightgray'}}/>
                                                <Avatar alt="Agnes Walker" src="https://picsum.photos/id/237/200/300"
                                                        style={{border: '0.1px solid lightgray'}}/>
                                        ...
                                        <TableCell>
                                            <div className={'d-flex'}>
                                                <Avatar src={row.activity} alt={'Activity'}  sx={{ bgcolor: green[500] }} variant="rounded"/>
                                                <a className={'m-1'} href={'#'}>Don</a>

                                            </div><span>25 Mins Ago</span>
                                        </TableCell>
                                    </TableRow>
                                ))}
                            </TableBody>
