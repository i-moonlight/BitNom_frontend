...
import {Box, Card, makeStyles, Tab, Tabs, Typography} from "@material-ui/core";
...
const custom = {
    ...
    cardsContainer: {
        width:'200px', backgroundColor:'rgb(68 63 63 / 50%)', borderRadius:'5px', marginLeft: '20px'
    }
};
    ...
    return (
        <Card>
            ...
            >
                ...
                >
                    <Tab style={custom.tabStyle} label="Team" {...tabProps(0)} />
                    <Tab style={custom.tabStyle} label="Investors" {...tabProps(1)} />
                </Tabs>
                <TabPanel value={value} index={0}>
                            ...
                            <div className={'row'} style={custom.cardsContainer}>
                                <div className={'col-3'}>
                                    <img
                                        ...
                                        className="rounded-circle" alt="Cinque Terre" width="30" height="30"
                                    />
                                </div>
                                <div className={'col-9'}>
                                    <p>Don Phelix <span>Bitcoin Core Contributor</span></p>
                    ...
                    <div className={'mt-5'}>
                        <h4><strong>Maintainers</strong></h4>
                        <hr />
                        <div className={'d-flex justify-content-between'}>
                            <div className={'row'} style={custom.cardsContainer}>
                                <div className={'col-3'}>
