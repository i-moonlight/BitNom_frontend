...
import {Card, CircularProgress, Container, Divider, Tab, Typography} from '@mui/material';
                ...
                <Container>
                    ...
                    <div className="container mt-3">
                        <div className="d-lg-flex d-md-flex d-sm-block row">
                            <Typography color="textPrimary" className="d-lg-flex d-md-flex d-sm-block col-lg-7
                         col-md-7 col-sm-12 mt-3 justify-content-evenly">
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <span className={'text-secondary'}>
                                            {coinDetail.name} <span className={'text-uppercase'}>({coinDetail.symbol})</span>
                                        </span>
                                            <a style={custom.greenBg}>#{coinDetail.coingecko_rank}</a>{' '}
                                            <Star />
                                        </p>
                                        <h5>
                                            <span>$47,811.67</span>{' '}
                                        ...
                                        <p>
                                            <Button variant="contained" style={custom.buttonStyle}>
                                                Coin
                                            </Button>
                                            <Button variant="contained" style={custom.buttonStyle}>
                                ...
                                <div>
                                    <div className={'mt-5'}>
                                        ...
                                        <section className={'d-flex justify-content-between'}>
                                            <p className={'text-success text-sm-end'}>
                                                $1,687,456
                                            </p>
                                            <p className={'text-success  text-sm-end'}>
                                                $1,687,456
                            ...
                            <Typography color="textPrimary" className="col-lg-5 col-md-5 col-sm-12">
                        ...
                        <TabContext value={value} variant="standard">
                            <div>
                                ...
                                <TabList onChange={handleChange} aria-label="lab API tabs example" className={'m-2'}
                                    ...
                                    <Button textColor={'#333333'} className={'float-end'} style={{ marginLeft: '5%',backgroundColor:'#333333' }}>
                                        <ShareTwoTone />
