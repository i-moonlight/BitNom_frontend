                    ...
                    <Table sx={{maxHeight: 500}} aria-label='coins table' stickyHeader>
                        <TableHead>
                            <TableRow>
                                ...
                                <StyledTableCell align='right'>Change(24)</StyledTableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                            {(coins.map((row, id) => (
