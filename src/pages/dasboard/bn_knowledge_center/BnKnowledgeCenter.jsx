...
function createData(
    ...
    return { star, ash, coin_image, coin, currency, price, h_1, h_24, d_7, volume_24, mkt_cap, last_7_days };
}
                ...
                <section className="d-flex flex-row">
                            ...
                            <CardContent>
                                <Typography variant="caption">
                                    <div className='float-md-right'>
                                        <span className='text-danger float-end'>-4.9 %</span><br/><br/>
                                        <h6><strong>$1,964,164,087,420</strong></h6>
                    ...
                    <div className="m-2">
                        <Card variant="contained"
                              color="primary" style={borders.volume}>
                            <CardContent>
                                <Typography variant="caption">
                                    <div className='float-md-right'>
                                        <span className='text-danger float-end'> -4.9 %</span><br/><br/>
                    ...
                    <div className="m-2">
                        <Card
                            variant="contained"
                            color="primary" style={borders.carp}>
                            <CardContent>
                                <Typography variant="caption">
                                    <div className='float-md-right'>
                                        <span className='text-info float-end'>Bitcoin</span><br/><br/>
                                        <h6><strong>42.84%</strong></h6>
                    ...
                    <div className="m-2">
                        <Card
                            variant="contained"
                            color="primary" style={borders.nft}>
                            <CardContent>
                                <Typography variant="caption">
                                    <div>
                                        <br/><br/>
                                        <h6><strong>456</strong></h6>
                    ...
                    <div className="m-2">
                        <Card
                            variant="contained"
                            color="primary" style={borders.coins}>
                            <CardContent>
                                <Typography variant="caption">
                                    <div><br/><br/>
                                        <h6><strong>9,076</strong></h6>
